...
class Events(InlineUnit):
    async def _message_handler(self, message: AiogramMessage):
        ...
        if message.chat.type != "private" or message.text == "/start shaxsiy tashabbus":
            return
        ...
        for mod in self._allmodules.modules:
            ...
            try:
                ...
                logger.exception("Aiogram kuzatuvchini ishga tushirishda xato!")
            ...
            for button in utils.array_sum(unit.get("buttons", [])):
                ...
                if button.get("_callback_data") == call.data:
                    if (
                        ...
                        await call.answer("Ushbu tugmani bosishingiz mumkin emas!")
                        return
                    ...
                    try:
                        ...
                        logger.exception("Qayta qo'ng'iroqni kuzatuvchini ishga tushirishda xato!")
                        await call.answer(
                            "So‘rovni ko‘rib chiqishda xatolik yuz berdi.  Batafsil maʼlumot ichida"
                            " jurnallar",
                            show_alert=True,
                        )
                        return
            ...
            for button in utils.array_sum(unit.get("buttons", [])):
                if (
                    ...
                    try:
                        ...
                        logger.exception(
                            "Tanlangan so'rov kuzatuvchisini ishga tushirishda istisno!"
                        )
                        return
    ...
    async def _query_help(self, inline_query: InlineQuery):
                ...
                (
                    InlineQueryResultArticle(
                        ...
                        reply_markup=self.generate_markup(
                            {
                                "text": "🏌️ Buyruqni ishga tushirish",
            ...
            await inline_query.answer(
                [
                    InlineQueryResultArticle(
                        ...
                        description="Sizda mavjud buyruqlar yo'q",
                        input_message_content=InputTextMessageContent(
                            "<b>😔 Mavjud inline buyruqlar yo'q yoki sizda yetishmaydi"
                            " ularga kirish</b>",
                            "HTML",
                            disable_web_page_preview=True,
                        ),
        ...
        await inline_query.answer(
            [
                InlineQueryResultArticle(
                    id=utils.rand(20),
                    title="📄 Barcha mavjud inline buyruqlarni ko'rsatish",
                    description=f"ℹ️ Sizda {len(_help)} buyruq(lar) bor",
                    input_message_content=InputTextMessageContent(
                        "<b>ℹ️ Mavjud inline buyruqlar:</b>\n\n{}".format(
