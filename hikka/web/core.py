...
class Web(root.Web):
    ...
    def _kill_tunnel(self):
        try:
            ...
            logger.debug("Proksi o'tish tuneli halok bo'ldi")
    ...
    async def _reopen_tunnel(self):
        ...
        if not url:
            raise Exception("Proksi-serverning url manzilini olib bo‘lmadi")
    ...
    async def favicon(_):
        return web.Response(
            status=301,
            headers={"Manzil": "https://siasky.net/jADBfWhaphoeaP5yFFNoYQ6NGqxfFXwZMfRWAjgJabEkug"},
        )
