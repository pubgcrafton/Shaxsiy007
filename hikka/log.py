...
class TelegramLogsHandler(logging.Handler):
    """
    2 ta buferni saqlaydi.
     Biri yuborilgan xabarlar uchun.
     Biri foydalanilmagan xabarlar uchun.
     2 ning uzunligi birgalikda 100 ga teng bo'lganda
     ularni birga 100 ta qilish uchun qisqartiring,
     avval qirqish bajariladi, keyin ishlatilmaydi.
    """
        ...
        for client_id in self._mods:
            ...
            if len(self._queue[client_id]) > 5:
                ...
                await self._mods[client_id].inline.bot.send_document(
                    ...
                    logfile,
                    caption=(
                        "<b>🧳 Jurnallar alohida xabarlar sifatida yuborish uchun juda katta</b>"
                    ),
                )
