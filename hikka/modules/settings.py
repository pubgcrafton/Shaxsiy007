...
class CoreMod(loader.Module):
    ...
    strings = {
        "name": "Settings",
        "too_many_args": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Juda ko'p arg</b>"
        ),
        "blacklisted": (
            '<emoji document_id="5368324170671202286">👍</emoji> <b>Chat {} qora rõyxatda'
            " userbotdan</b>"
        ),
        "unblacklisted": (
            '<emoji document_id="5368324170671202286">👍</emoji> <b>Chat {}'
            " foydalanuvchi tomonidan ro'yxatga olinmagan</b>"
        ),
        "user_blacklisted": (
            '<emoji document_id="5368324170671202286">👍</emoji> <b>User {} qora rõyxatda'
            " userbotdan</b>"
        ),
        "user_unblacklisted": (
        ...
        "prefix_set": (
            ...
            " yangilandi. Turi</b> <code>{newprefix}setprefix {oldprefix}</code> <b>ga"
            " uni orqaga o'zgartiring</b>"
        ),
        "alias_created": (
            '<emoji document_id="5368324170671202286">👍</emoji> <b>Taxallus yaratildi.'
            " Unga kiring</b> <code>{}</code>"
        ),
        ...
        "alias_args": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Siz taqdim qilishingiz kerak"
            " buyruq va unga taxallus</b>"
        ),
        "delalias_args": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Siz ta'minlashingiz kerak"
            " taxallus nomi</b>"
        ),
        "alias_removed": (
            '<emoji document_id="5368324170671202286">👍</emoji> <b>Taxallus</b>'
            " <code>{}</code> <b>olib tashlandi</b>."
        ),
        "no_alias": (
        ...
        "db_cleared": (
            '<emoji document_id="5368324170671202286">👍</emoji><b> Malumotlar bazasi tozalandi</b>'
        ),
        "hikka": (
            "{}\n\n<emoji document_id=5406931726184225260>🧐</emoji>"
            " <b>Version: {}.{}.{}</b>\n<emoji"
            " document_id=6318902906900711458>🧱</emoji> <b>Quring:"
            " </b><i>{}</i>\n\n<emoji document_id=5233346091725888979>⚙️</emoji> <b>Shaxsiy-TL: </b><i>{}</i>\n\n<emoji document_id=5454182070156794055>⌨️</emoji>"
            " <b>Tuzuvchi: t.me/doniyor_tm</b>"
        ),
        "check_url": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Siz belgilashingiz kerak"
            " langpakni o'z ichiga olgan haqiqiy url</b>"
        ),
        ...
        "lang_removed": (
            '<emoji document_id="5368324170671202286">👍</emoji> <b>Tarjimalarni tiklash'
            " standartlariga</b>"
        ),
        "check_pack": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Paket formati noto‘g‘ri"
            " url ichida</b>"
        ),
        "confirm_cleardb": "⚠️ <b>Ma'lumotlar bazasini tozalashni xohlaysizmi?</b>",
